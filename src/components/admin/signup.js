const Signup = {
  ...
  <div class="bg-white w-full md:max-w-md lg:max-w-full  md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
    ...
    <div class="w-full h-100">
      ...
      <h1 class="text-xl md:text-2xl font-bold leading-tight mt-12">Register an account</h1>
      ...
      <form class="mt-6" action="#" method="POST">
        ...
        <div class="mt-4">
          ...
          <input type="text" name="" id="" placeholder="Enter Password" minlength="6" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500
      ...
      <p class="mt-8">Do you already have an account? <a href="#" class="text-blue-500 hover:text-blue-700 font-semibold">Singin</a></p>
